...
//354518f46abaaec4ef62011653603be0be140000f7a4bbdbe9bc2980e7ff94f3fe0e  00 4d415062    01f5ae9181 000000
//354518f46abaaec4ef62011653603be0be140000f7a4bbdbe9bc2980e7ff94f3fe0e     4d415062 00 01f5ae9181 000000
/* 23 */ 
@Serializable
...
//354518f46abaaec4ef620117 9385a8f8eadd0c b0fb5f453bf10000b79ae6feaee10c                80cbc292f2e011 00000000000000 0000
//354518f46abaaec4ef620117                b0fb5f453bf10000b79ae6feaee10c 9385a8f8eadd0c 80cbc292f2e011 00000000000000 0000
/* 24 */ 
@Serializable
...
data class WithdrawPermissionCreateOperation(
    ...
    @Serializable(with = TimePointSecSerializer::class)
    val period_start_time: Instant, // Time at which the first withdrawal period begins; must be in the future
) : Operation()
/* 26 */ 
@Serializable
data class WithdrawPermissionUpdateOperation(
    ...
    @Serializable(with = TimePointSecSerializer::class)
    val period_start_time: Instant, // New beginning of the next withdrawal period; must be in the future
...
data class WorkerCreateOperation(
    ...
    @Serializable(with = TimePointSecSerializer::class)
    val work_begin_date: Instant,
    @Serializable(with = TimePointSecSerializer::class)
    val work_end_date: Instant,
...
data class HtlcRedeemOperation(
    ...
    val preimage: BinaryData, // the preimage (not used if after epoch timeout)
    val extensions: FutureExtensions, // for future expansion
) : Operation()
...
data class CustomAuthorityCreateOperation(
    ...
    @Serializable(with = TimePointSecSerializer::class)
    val valid_from: Instant, // Date when custom authority becomes active
    @Serializable(with = TimePointSecSerializer::class)
    val valid_to: Instant, // Expiration date for custom authority
...
data class CustomAuthorityUpdateOperation(
    ...
    val new_valid_from: Optional<@Serializable(with = TimePointSecSerializer::class) Instant> = optional(), // Change to the custom authority begin date
    val new_valid_to: Optional<@Serializable(with = TimePointSecSerializer::class) Instant> = optional(), // Change to the custom authority expiration date
...
data class TicketCreateOperation(
    ...
    val extensions: FutureExtensions, // Unused. Reserved for future use.
) : Operation()
...
data class CreditOfferCreateOperation(
    ...
    @Serializable(with = TimePointSecSerializer::class)
    val auto_disable_time: Instant, // The time when this offer will be disabled automatically
